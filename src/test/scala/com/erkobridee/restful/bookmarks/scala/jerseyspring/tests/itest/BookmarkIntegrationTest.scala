package com.erkobridee.restful.bookmarks.scala.jerseyspring.tests.itest
...
import com.erkobridee.restful.bookmarks.scala.jerseyspring.tests.Singleton.vo_=
...
class BookmarkIntegrationTest {
  ...
  def getBaseUrl(
    port:String = "8080",
    app:String = "restful-bookmarks-scala-jerseyspring",
    context:String = "rest",
